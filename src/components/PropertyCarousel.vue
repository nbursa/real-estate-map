<template>
    <carousel :key="`carousel-${props.property.id}`" class="mb-4" :autoplay="2000" :items-to-show="1" :items-to-scroll="1"
        :wrap-around="true" :navigation-enabled="true" :min-swipe-distance="1" :current-slide.sync="currentSlide"
